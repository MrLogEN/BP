...
\includegraphics[width=.70\textwidth]{img/ukazka-obr01}
...
\caption{Maximálně věrohodné odhady modelů 1 a 2 (data ČSÚ, vlastní zpracování)}\label{tab03:Nejaka}
\begin{tabular}{lrr}
\toprule
...
Výška (cm)                	   & 0,78***     &(0,12)	\\
\bottomrule
\multicolumn{3}{p{.45\textwidth}}{\footnotesize \textit{Pozn:}: 
