\FloatBarrier
\subsection{Aplikace openSenseMap}
...
Data z platformy openSenseMap jsou přístupná třemi způsoby. Prvním je \textit{REST API}, které poskytuje data ve formátech JSON, GeoJSON a CSV. API umožňuje dotazování na metadata senzorových stanic, jednotlivá měření i hromadný export dat z více stanic současně. Dotazy lze filtrovat podle sledované veličiny, geografické oblasti, typu prostředí nebo modelu senzorové stanice. Pro jednotlivý senzor je omezení na 10\,000 záznamů, resp. maximálně 1 měsíc dat na jeden dotaz. Pro čtení dat není vyžadována autentizace, vyžadována je pouze pro operace zápisu. \parencite{OpenSenseMapAPIDocumentation}
...
\footnotesize \textit{Poznámka:} Ukázka bodového grafu zobrazujícího jednotlivé naměřené hodnoty vybrané veličiny za vybrané časové období pro konkrétní senzor. 
