\FloatBarrier
\subsection{Aplikace sensor.community}
...
\begin{itemize}
  \item sledované veličiny, a to:
    \begin{itemize}
      ...
      \item tlak,
      \item hluk,
      \item AQI US\footnote{Index kvality ovzduší (AQI) je souhrnný ukazatel agentury EPA informující o~denní kvalitě ovzduší. Vychází z~pěti hlavních znečišťujících látek regulovaných zákonem o~čistém ovzduší: přízemního ozonu, prachových částic, oxidu uhelnatého, oxidu siřičitého a~oxidu dusičitého. \parencite{usdepartmentofcommerceAirQualityIndex}},
      \item PM$_{2.5}$,
      \item PM$_{10}$,
    \end{itemize}
...
Na rozhraní můžeme také vidět barevnou škálu pro právě vybranou veličinu (viz č. 1 na obrázku č. \ref{obr:sensor-community-filter}). Po vybrání veličiny je možné vybrat jeden či více zobrazovaných senzorů a získat tak konkrétní naměřenou hodnotu (viz obrázek č. \ref{obr:sensor-community-sensor-reading}).
