...
Webové rozhraní aplikace je pro zobrazování dat na světové mapě podobné jako u aplikace Sensor.Community (viz obrázek č. \ref{obr:openaq-map}). Uživatelské rozrhraní je pro zobrazování dat přístupné bez předchozí regitrace. Uživatelé mohou zobrazení výsledků filtrovat podle: 
\begin{itemize}
