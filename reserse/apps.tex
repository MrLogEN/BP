...
V první části této kapitoly je uveden stručný přehled každé z těchto aplikací a jejich funkcionalit.
...
\FloatBarrier
\section{Přehled aplikací}

\input{reserse/apps/sensor_community}

\input{reserse/apps/openaq}

\input{reserse/apps/open_sense_map}

\input{reserse/apps/indoor_co2_map}

\input{reserse/apps/srovnani}
