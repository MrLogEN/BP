...
\caption{Případ užití: #1}\label{tab:usecase:#2}\tabularnewline

\toprule
\textbf{Název případu užití} & \multicolumn{3}{l}{#1} \\
\midrule

\textbf{Identifikace případu užití} & \multicolumn{3}{l}{#2} \\
\textbf{Identifikace funkčního požadavku} & \multicolumn{3}{l}{#3} \\
\textbf{Cíl případu užití} & \multicolumn{3}{l}{#4} \\
\textbf{Primární aktér(ři)} & \multicolumn{3}{l}{#5} \\
\textbf{Pomocný aktér(ři)} & \multicolumn{3}{l}{#6} \\
\textbf{Vstupní podmínky} & \multicolumn{3}{l}{#7} \\
\textbf{Výstupní podmínky} & \multicolumn{3}{l}{#8} \\
